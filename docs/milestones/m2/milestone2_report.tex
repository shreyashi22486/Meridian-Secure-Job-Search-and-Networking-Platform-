...
This report covers Milestone~2 of the Meridian platform, due February~27, 2026 (weight: 2.5\%). The milestone required five deliverables:
...
% ═══════════════════════════════════════════════════════════════════════
\input{../../report/sections/milestone2}

% ═══════════════════════════════════════════════════════════════════════
%  Security Summary
% ═══════════════════════════════════════════════════════════════════════
\newpage
\input{../../report/sections/security}
